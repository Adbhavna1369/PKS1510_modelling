...
sed_path = "/home/pc/Desktop/Thesis Datasets/mwl_sed_2012.ecsv"
...
#nu_100_GeV = (100 * u.GeV).to("Hz", equivalencies=u.spectral())
#nu_1_GeV = (1 * u.GeV).to("Hz", equivalencies=u.spectral())
